...
```bash
node ~/.gemini/skills/token-tracker/scripts/report-token-usage.js
```
...
```bash
node ~/.gemini/skills/token-tracker/scripts/set-token-context.js --workspace "$PWD" --feature "<name>"
```

Or to clear:

```bash
node ~/.gemini/skills/token-tracker/scripts/set-token-context.js --workspace "$PWD" --clear-feature
```
...
```bash
node ~/.gemini/skills/token-tracker/scripts/save-token-usage.js --json '<snapshot-json>'
```
...
```bash
node ~/.gemini/skills/token-tracker/scripts/set-token-context.js --workspace "$PWD" --feature "maintenance"
```
...
```bash
node ~/.gemini/skills/token-tracker/scripts/statusline-token-usage.js
```
